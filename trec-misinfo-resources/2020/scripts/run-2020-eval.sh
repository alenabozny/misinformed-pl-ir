...
ADHOC_OUT_DIR="$BASE_DIR/run-summaries/adhoc/2020"
RECALL_OUT_DIR="$BASE_DIR/run-summaries/recall"

# directories with the runs to evaluate
ADHOC="$BASE_DIR/misinfo-runs/adhoc/2020/"
RECALL="$BASE_DIR/misinfo-runs/recall/"
QRELS="$BASE_DIR/trec-misinfo-resources/2020/qrels/2020-derived-qrels"
