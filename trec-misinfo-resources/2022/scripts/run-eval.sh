...
ADHOC_OUT_DIR="$BASE_DIR/run-summaries/adhoc/2022"
AP_OUT_DIR="$BASE_DIR/run-summaries/prediction"

# directories with the runs to evaluate
ADHOC="$BASE_DIR/misinfo-runs/adhoc/2022/"
PREDICTION="$BASE_DIR/misinfo-runs/prediction/"

QRELS="$BASE_DIR/trec-misinfo-resources/2022/qrels/2022-derived-qrels"
TOPICS="$BASE_DIR/trec-misinfo-resources/2022/topics/misinfo-2022-topics.xml"

# extended trec_eval: https://github.com/lcschv/Trec_eval_extension
trec_eval="$BASE_DIR/trec-misinfo-resources/Trec_eval_extension/Trec_eval_extension/trec_eval"
# https://github.com/trec-health-misinfo/Compatibility
compatibility="$BASE_DIR/trec-misinfo-resources/Compatibility/compatibility.py"
ap_evaluation="$BASE_DIR/trec-misinfo-resources/2022/scripts/answer_prediction_evaluation.py"
