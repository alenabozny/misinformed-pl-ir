...
ADHOC_OUT_DIR="$BASE_DIR/run-summaries/adhoc/2021"

# directories with the runs to evaluate
ADHOC="$BASE_DIR/misinfo-runs/adhoc/2021/"

QRELS="$BASE_DIR/trec-misinfo-resources/2021/qrels/2021-derived-qrels"
